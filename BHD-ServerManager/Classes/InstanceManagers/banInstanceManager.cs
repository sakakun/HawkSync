...
namespace BHD_ServerManager.Classes.InstanceManagers
{
    public static class banInstanceManager
    {
        ...
        public static void AddBannedPlayer(string playerName, IPAddress playerIP = null!, int subnetMask = 32)
        {
        ...
        public static bool RemoveBannedPlayerName(int recordId)
        {
        ...
        public static bool RemoveBannedPlayerAddress(int recordId)
        {
        ...
        public static bool RemoveBannedPlayerBoth(int recordId)
        {
        ...
        public static void UpdateBannedTables()
        {
        ...
        public static void ImportSettingsFromBase64(string base64Data, string fileType)
        {
            try
            {
        ...
        private static void ImportSettingsFromFile(string importPath)
        {
            try
            {
        ...
        private static void ImportSettingsFromString(string content, bool isJson)
        {
            try
            {
                if (isJson)
        ...
        private static void ImportIniBanString(string iniContent)
        {
