...
namespace BHD_ServerManager.Classes.InstanceManagers
{
    public class mapInstanceManager
    {
        ...
        public static void ResetAvailableMaps()
        {
        ...
        public static void SaveCurrentMapPlaylist(List<mapFileInfo> mapList, bool external)
        {
        ...
        public static string[]? GetFileLinesFromDialog(bool saveDialog, string filter, string title, string initialDirectory, string defaultFileName)
        {
        ...
        public static List<mapFileInfo> LoadCustomMapPlaylist(bool external = false)
        {
        ...
        public static List<mapFileInfo> BuildCurrentMapPlaylist()
        {
        ...
        public static void CalculateGameTypeBits(List<int> numbers, int target, List<int> result)
        {
