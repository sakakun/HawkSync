namespace RemoteClient.Forms.Panels
{
    partial class tabAdmin
    {
		...
		private void InitializeComponent()
		{
			...
			checkBox_permAudit = new CheckBox();
			...
			checkBox_permAudit.Dock = DockStyle.Fill;
			checkBox_permAudit.Location = new Point(260, 62);
			checkBox_permAudit.Name = "checkBox_permAudit";
			checkBox_permAudit.Padding = new Padding(20, 3, 0, 0);
			checkBox_permAudit.Size = new Size(121, 24);
			checkBox_permAudit.TabIndex = 9;
		...
		private CheckBox checkBox_permAudit;
	}
}
