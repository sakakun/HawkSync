namespace RemoteClient.Forms.Panels
{
    partial class tabChat
    {
		...
		private void InitializeComponent()
		{
			...
			chat_TabControl.Controls.Add(tabChatHistory);
			...
			// tabChatHistory
			// 
			tabChatHistory.Controls.Add(chatHistory1);
			tabChatHistory.Location = new Point(4, 4);
			tabChatHistory.Name = "tabChatHistory";
			tabChatHistory.Size = new Size(935, 414);
			tabChatHistory.TabIndex = 3;
			tabChatHistory.Text = "Chat History";
			tabChatHistory.UseVisualStyleBackColor = true;
			// 
			// tabAutoMessages
			// 
			...
			tabChatHistory.ResumeLayout(false);
